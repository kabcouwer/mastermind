...
RSpec.describe Mastermind do
  ...
  xit 'can create a new code after playing a round' do
    mastermind1 = Mastermind.new
    # require 'pry'; binding.pry
    first_round_code = mastermind1.solution
    mastermind1.play_again
    next_round_code = mastermind1.solution
    require 'pry'; binding.pry
    expect(first_round_code).to not_equal(next_round_code)
  end
